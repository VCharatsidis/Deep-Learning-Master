...
class Solver(object):
    ...
    def fit(self, x_train, y_train, optimizer, optimizer_config = {}, x_val = None, y_val = None,
          batch_size = 200, num_iterations = 1000, val_iteration = 100, verbose = True):
        """
        ...
        for iteration in range(num_iterations):
          ...
          ########################################################################################
            ...
            if iteration % val_iteration  == 0 or iteration == num_iterations - 1:
                ...
                if verbose:
                    print("Iteration {0:d}/{1:d}. Train Loss = {2:.3f}, Train Accuracy = {3:.3f}".format(iteration, num_iterations, train_loss, train_acc))
    ...
    def accuracy(self, out, y):
        ...
        #accuracy
        predictions = np.argmax(out,1)
        matches = predictions == y
        accuracy = np.sum(matches) / float(y.shape[0])
